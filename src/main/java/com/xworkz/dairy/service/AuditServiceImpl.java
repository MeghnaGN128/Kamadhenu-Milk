...
import com.xworkz.dairy.repository.AdminAuditRepository;
...
public class AuditServiceImpl implements AuditService {
    @Autowired
    private AdminAuditRepository auditRepo;
    ...
    public void logAdminAuditSave(AdminDTO adminDTO) {
        ...
        AdminEntity admin = adminService.findByEmailEntity(adminDTO.getEmail());
 ...
 /*   @Autowired
    ...
    public void logAdminLogin(AdminEntity admin) {
        ...
        log.info("Audit: Login recorded for {}", admin.getEmail());
    }
    @Override
    public void logAdminLogout(AdminEntity admin) {
        ...
        auditRepo.saveOrUpdate(audit);
        log.info("Audit: Logout recorded for {}", admin.getEmail());
    }
